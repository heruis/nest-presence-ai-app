...
- **UX study scope.** 10-interview concept/prototype review (phone, ~10 min each, week of 2026-05-12). Nine of ten interviewees reasoned hypothetically without owning smart-home devices; one owned ~3. The study captures *reaction to the idea* better than *behavior in use* — a pre-launch beta would be the appropriate next instrument. The study sharpened the trust ramp around Suggest Mode, Undo, feedback learning, and Last Person Left as the clearest value case; no post-study prototype changes were implemented. Full summary in [`APPENDIX.md`](./APPENDIX.md) §2.
